...
type
    ...
    RelocMode* {.size: sizeof(cint).} = enum
        RelocDefault, RelocStatic, RelocPIC, RelocDynamicNoPic, RelocROPI,
                RelocRWPI,
        RelocROPI_RWPI
...
proc getNextTarget*(t: TargetRef): TargetRef {.cdecl,
        importc: "LLVMGetNextTarget",
    dynlib: LLVMlib.}
## ===-- Target ------------------------------------------------------------===
...
proc getTargetName*(t: TargetRef): cstring {.cdecl,
        importc: "LLVMGetTargetName",
    dynlib: LLVMlib.}
