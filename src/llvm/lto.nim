...
proc ltoModuleHasObjcCategory*(mem: pointer; length: csize_t): LtoBoolT {.cdecl, importc: "lto_module_has_objc_category", dynlib: LLVMlib.}
    ##  Return true if \p Buffer contains a bitcode file with ObjC code (category
    ##  or class) in it.
    ##
    ##  \since LTO_API_VERSION=20

proc ltoModuleIsObjectFileInMemory*(mem: pointer; length: csize_t): LtoBoolT {.cdecl, importc: "lto_module_is_object_file_in_memory", dynlib: LLVMlib.}
    ##  Checks if a buffer is a loadable object file.
    ##
    ##  \since prior to LTO_API_VERSION=3

proc ltoModuleIsObjectFileInMemoryForTarget*(mem: pointer; length: csize_t;targetTriplePrefix: cstring): LtoBoolT {.cdecl, importc: "lto_module_is_object_file_in_memory_for_target", dynlib: LLVMlib.}
...
proc ltoModuleCreateFromMemory*(mem: pointer; length: csize_t): LtoModuleT {.cdecl, importc: "lto_module_create_from_memory", dynlib: LLVMlib.}
    ##  Loads an object file from memory.
    ##  Returns NULL on error (check lto_get_error_message() for details).
    ##
    ##  \since prior to LTO_API_VERSION=3

proc ltoModuleCreateFromMemoryWithPath*(mem: pointer; length: csize_t;path: cstring): LtoModuleT {. cdecl, importc: "lto_module_create_from_memory_with_path", dynlib: LLVMlib.}
    ##  Loads an object file from memory with an extra path argument.
    ##  Returns NULL on error (check lto_get_error_message() for details).
    ##
    ##  \since LTO_API_VERSION=9

proc ltoModuleCreateInLocalContext*(mem: pointer; length: csize_t;path: cstring): LtoModuleT {. cdecl, importc: "lto_module_create_in_local_context", dynlib: LLVMlib.}
...
proc ltoModuleCreateInCodegenContext*(mem: pointer; length: csize_t; path: cstring;cg: LtoCodeGenT): LtoModuleT {.cdecl, importc: "lto_module_create_in_codegen_context", dynlib: LLVMlib.}
...
proc ltoModuleCreateFromFd*(fd: cint; path: cstring;fileSize: csize_t): LtoModuleT {. cdecl, importc: "lto_module_create_from_fd", dynlib: LLVMlib.}
    ##  Loads an object file from disk. The seek point of fd is not preserved.
    ##  Returns NULL on error (check lto_get_error_message() for details).
    ##
    ##  \since LTO_API_VERSION=5

proc ltoModuleCreateFromFdAtOffset*(fd: cint; path: cstring; fileSize: csize_t;mapSize: csize_t; offset: OffT): LtoModuleT {.cdecl, importc: "lto_module_create_from_fd_at_offset", dynlib: LLVMlib.}
    ##  Loads an object file from disk. The seek point of fd is not preserved.
    ##  Returns NULL on error (check lto_get_error_message() for details).
    ##
    ##  \since LTO_API_VERSION=5
...
proc ltoCodegenCompile*(cg: LtoCodeGenT; length: ptr csize_t): pointer {.cdecl, importc: "lto_codegen_compile", dynlib: LLVMlib.}
...
proc ltoCodegenCompileOptimized*(cg: LtoCodeGenT; length: ptr csize_t): pointer {.cdecl, importc: "lto_codegen_compile_optimized", dynlib: LLVMlib.}
...
type
    LtoInputT* = ptr OpaqueLTOInput
        ## * Opaque referencen LTO input file


proc ltoInputCreate*(buffer: pointer; bufferSize: csize_t;path: cstring): LtoInputT {. cdecl, importc: "lto_input_create", dynlib: LLVMlib.}
...
proc ltoInputGetDependentLibrary*(input: LtoInputT; index: csize_t;size: ptr csize_t): cstring {. cdecl, importc: "lto_input_get_dependent_library", dynlib: LLVMlib.}
...
proc ltoRuntimeLibSymbolsList*(size: ptr csize_t): cstringArray {.cdecl, importc: "lto_runtime_lib_symbols_list", dynlib: LLVMlib.}
...
proc thinltoCodegenSetFinalCacheSizeRelativeToAvailableSpace*(  cg: ThinltoCodeGenT; percentage: cuint) {.cdecl, importc: "thinlto_codegen_set_final_cache_size_relative_to_available_space", dynlib: LLVMlib.}
