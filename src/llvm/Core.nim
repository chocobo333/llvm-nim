...
proc contextCreate*(): ContextRef {.cdecl, importc: "LLVMContextCreate", dynlib: LLVMlib.}
## *
##  Obtain the global context instance.
##

proc getGlobalContext*(): ContextRef {.cdecl, importc: "LLVMGetGlobalContext", dynlib: LLVMlib.}
## *
...
proc getEnumAttributeKindForName*(name: cstring; sLen: csize): cuint {.cdecl, importc: "LLVMGetEnumAttributeKindForName", dynlib: LLVMlib.}
proc getLastEnumAttributeKind*(): cuint {.cdecl,
                                       importc: "LLVMGetLastEnumAttributeKind",
                                       dynlib: LLVMlib.}
## *
...
proc moduleCreateWithName*(moduleID: cstring): ModuleRef {.cdecl, importc: "LLVMModuleCreateWithName", dynlib: LLVMlib.}
## *
...
proc cloneModule*(m: ModuleRef): ModuleRef {.cdecl, importc: "LLVMCloneModule", dynlib: LLVMlib.}
## *
...
proc disposeModule*(m: ModuleRef) {.cdecl, importc: "LLVMDisposeModule", dynlib: LLVMlib.}
## *
...
proc getModuleIdentifier*(m: ModuleRef; len: ptr csize): cstring {.cdecl, importc: "LLVMGetModuleIdentifier", dynlib: LLVMlib.}
## *
...
proc setModuleIdentifier*(m: ModuleRef; ident: cstring; len: csize) {.cdecl, importc: "LLVMSetModuleIdentifier", dynlib: LLVMlib.}
## *
...
proc getSourceFileName*(m: ModuleRef; len: ptr csize): cstring {.cdecl, importc: "LLVMGetSourceFileName", dynlib: LLVMlib.}
## *
...
proc setSourceFileName*(m: ModuleRef; name: cstring; len: csize) {.cdecl, importc: "LLVMSetSourceFileName", dynlib: LLVMlib.}
## *
...
proc setDataLayout*(m: ModuleRef; dataLayoutStr: cstring) {.cdecl, importc: "LLVMSetDataLayout", dynlib: LLVMlib.}
## *
...
proc getTarget*(m: ModuleRef): cstring {.cdecl, importc: "LLVMGetTarget", dynlib: LLVMlib.}
## *
...
proc moduleFlagEntriesGetKey*(entries: ptr ModuleFlagEntry; index: cuint;len: ptr csize): cstring {.cdecl, importc: "LLVMModuleFlagEntriesGetKey", dynlib: LLVMlib.}
## *
...
proc getModuleFlag*(m: ModuleRef; key: cstring; keyLen: csize): MetadataRef {.cdecl, importc: "LLVMGetModuleFlag", dynlib: LLVMlib.}
## *
##  Add a module-level flag to the module-level flags metadata if it doesn't
##  already exist.
##
...
proc addModuleFlag*(m: ModuleRef; behavior: ModuleFlagBehavior; key: cstring;keyLen: csize; val: MetadataRef) {.cdecl, importc: "LLVMAddModuleFlag", dynlib: LLVMlib.}
## *
...
proc dumpModule*(m: ModuleRef) {.cdecl, importc: "LLVMDumpModule", dynlib: LLVMlib.}
## *
...
proc printModuleToString*(m: ModuleRef): cstring {.cdecl, importc: "LLVMPrintModuleToString", dynlib: LLVMlib.}
## *
...
proc getModuleInlineAsm*(m: ModuleRef; len: ptr csize): cstring {.cdecl, importc: "LLVMGetModuleInlineAsm", dynlib: LLVMlib.}
## *
...
proc setModuleInlineAsm2*(m: ModuleRef; `asm`: cstring; len: csize) {.cdecl, importc: "LLVMSetModuleInlineAsm2", dynlib: LLVMlib.}
## *
...
proc appendModuleInlineAsm*(m: ModuleRef; `asm`: cstring; len: csize) {.cdecl, importc: "LLVMAppendModuleInlineAsm", dynlib: LLVMlib.}
## *
...
proc getInlineAsm*(ty: TypeRef; asmString: cstring; asmStringSize: csize;constraints: cstring; constraintsSize: csize;hasSideEffects: Bool; isAlignStack: Bool;dialect: InlineAsmDialect): ValueRef {.cdecl, importc: "LLVMGetInlineAsm", dynlib: LLVMlib.}
## *
...
proc addFunction*(m: ModuleRef; name: cstring; functionTy: TypeRef): ValueRef {.cdecl, importc: "LLVMAddFunction", dynlib: LLVMlib.}
## *
...
proc getTypeKind*(ty: TypeRef): TypeKind {.cdecl, importc: "LLVMGetTypeKind", dynlib: LLVMlib.}
## *
...
proc typeIsSized*(ty: TypeRef): Bool {.cdecl, importc: "LLVMTypeIsSized", dynlib: LLVMlib.}
## *
...
proc dumpType*(val: TypeRef) {.cdecl, importc: "LLVMDumpType", dynlib: LLVMlib.}
## *
...
proc printTypeToString*(val: TypeRef): cstring {.cdecl, importc: "LLVMPrintTypeToString", dynlib: LLVMlib.}
## *
...
proc functionType*(returnType: TypeRef; paramTypes: ptr TypeRef; paramCount: cuint;isVarArg: Bool): TypeRef {.cdecl, importc: "LLVMFunctionType", dynlib: LLVMlib.}
## *
...
proc voidType*(): TypeRef {.cdecl, importc: "LLVMVoidType", dynlib: LLVMlib.}
...
proc getValueName2*(val: ValueRef; length: ptr csize): cstring {.cdecl, importc: "LLVMGetValueName2", dynlib: LLVMlib.}
## *
...
proc setValueName2*(val: ValueRef; name: cstring; nameLen: csize) {.cdecl, importc: "LLVMSetValueName2", dynlib: LLVMlib.}
## *
...
proc dumpValue*(val: ValueRef) {.cdecl, importc: "LLVMDumpValue", dynlib: LLVMlib.}
## *
...
proc printValueToString*(val: ValueRef): cstring {.cdecl, importc: "LLVMPrintValueToString", dynlib: LLVMlib.}
## *
...
proc getAsString*(c: ValueRef; length: ptr csize): cstring {.cdecl, importc: "LLVMGetAsString", dynlib: LLVMlib.}
## *
...
proc lookupIntrinsicID*(name: cstring; nameLen: csize): cuint {.cdecl, importc: "LLVMLookupIntrinsicID", dynlib: LLVMlib.}
## *
...
proc getIntrinsicDeclaration*(`mod`: ModuleRef; id: cuint; paramTypes: ptr TypeRef;paramCount: csize): ValueRef {.cdecl, importc: "LLVMGetIntrinsicDeclaration", dynlib: LLVMlib.}
## *
...
proc intrinsicGetType*(ctx: ContextRef; id: cuint; paramTypes: ptr TypeRef;paramCount: csize): TypeRef {.cdecl, importc: "LLVMIntrinsicGetType", dynlib: LLVMlib.}
## *
...
proc intrinsicGetName*(id: cuint; nameLength: ptr csize): cstring {.cdecl, importc: "LLVMIntrinsicGetName", dynlib: LLVMlib.}
## *
...
proc getParamParent*(inst: ValueRef): ValueRef {.cdecl, importc: "LLVMGetParamParent", dynlib: LLVMlib.}
## *
...
proc addGlobalIFunc*(m: ModuleRef; name: cstring; nameLen: csize; ty: TypeRef;addrSpace: cuint; resolver: ValueRef): ValueRef {.cdecl, importc: "LLVMAddGlobalIFunc", dynlib: LLVMlib.}
## *
...
proc insertExistingBasicBlockAfterInsertBlock*(builder: BuilderRef;bb: BasicBlockRef) {.cdecl,
                       importc: "LLVMInsertExistingBasicBlockAfterInsertBlock",
                       dynlib: LLVMlib.}
## *
...
proc instructionGetAllMetadataOtherThanDebugLoc*(instr: ValueRef;numEntries: ptr csize): ptr ValueMetadataEntry {.cdecl, importc: "LLVMInstructionGetAllMetadataOtherThanDebugLoc", dynlib: LLVMlib.}
## *
...
proc createMemoryBufferWithMemoryRange*(inputData: cstring; inputDataLength: csize;bufferName: cstring;requiresNullTerminator: Bool): MemoryBufferRef {. cdecl, importc: "LLVMCreateMemoryBufferWithMemoryRange", dynlib: LLVMlib.}
proc createMemoryBufferWithMemoryRangeCopy*(inputData: cstring;inputDataLength: csize; bufferName: cstring): MemoryBufferRef {.cdecl, importc: "LLVMCreateMemoryBufferWithMemoryRangeCopy", dynlib: LLVMlib.}
proc getBufferStart*(memBuf: MemoryBufferRef): cstring {.cdecl, importc: "LLVMGetBufferStart", dynlib: LLVMlib.}
proc getBufferSize*(memBuf: MemoryBufferRef): csize {.cdecl, importc: "LLVMGetBufferSize", dynlib: LLVMlib.}
