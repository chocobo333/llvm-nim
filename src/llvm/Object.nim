...
proc machOUniversalBinaryCopyObjectForArch*(br: BinaryRef; arch: cstring;archLen: csize; errorMessage: cstringArray): BinaryRef {.cdecl, importc: "LLVMMachOUniversalBinaryCopyObjectForArch", dynlib: LLVMlib.}
## *
